        ...
        <div className="container mx-auto grid grid-cols-1 items-center justify-items-center gap-10 px-6 sm:px-8 md:grid-cols-2 lg:px-12">
          <div className="max-w-lg space-y-6">
            ...
            <p className="text-lg text-neutral-600 md:text-xl">
              Sacred Buddhist paintings crafted with traditional techniques and spiritual devotion.
            </p>
            <Button
              asChild
              variant="default"
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 sm:p-10 lg:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-amber-700">What is Thangka?</h3>
                  <p className="text-gray-700 leading-relaxed">
                    Thangka paintings are intricate Buddhist artworks on cotton or silk, originating from the Himalayan regions. 
                    These sacred scroll paintings serve as visual representations of Buddhist teachings, depicting deities, 
                    mandalas, and spiritual narratives with meticulous detail and profound symbolism.
                  </p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-amber-700">Sacred Symbolism</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-amber-700">Spiritual Functions</h3>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start">
                      <span className="text-amber-600 mr-2">•</span>
                      <span>Meditation aids for visualizing enlightened beings</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-amber-600 mr-2">•</span>
                      <span>Teaching tools illustrating Buddhist cosmology</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-amber-600 mr-2">•</span>
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-4 text-amber-700">Historical Journey</h3>
                  <p className="text-gray-700 leading-relaxed">
                    With roots in 7th century Nepal, thangka painting flourished through cultural exchanges along the Silk Road. 
                    The portable scroll format made these sacred artworks ideal for nomadic monks spreading Dharma across the 
                    Himalayan plateau, preserving spiritual traditions through generations.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-gray-900 text-white pt-16 pb-8">
        <div className="container mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            <div>
              <h3 className="text-xl font-bold mb-4 text-amber-500">Sacred Thangka Art</h3>
              <p className="text-gray-400 mb-4 leading-relaxed">
                Preserving ancient Buddhist art traditions with authenticity and devotion.
              </p>
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/share/1BgumDdvfR/" className="text-gray-400 hover:text-amber-500 transition-colors">
                  <span className="sr-only">Facebook</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="https://www.instagram.com/david187in?igsh=MWM1OWxnMmlrMWlnNA==" className="text-gray-400 hover:text-amber-500 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="#" className="text-gray-400 hover:text-amber-500 transition-colors">All Products</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-amber-500 transition-colors">Collections</Link></li>
                <li><Link href="/#" className="text-gray-400 hover:text-amber-500 transition-colors">New Arrivals</Link></li>
                <li><Link href="#" className="text-gray-400 hover:text-amber-500 transition-colors">Best Sellers</Link></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Sacred Thangka Art. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link href="/privacy" className="text-gray-500 hover:text-amber-500 text-sm transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="text-gray-500 hover:text-amber-500 text-sm transition-colors">Terms of Service</Link>
            </div>
          </div>
        </div>
      </footer>
